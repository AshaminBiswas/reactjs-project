...
export default function NikeSignIn() {
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center px-12">
            <div className="text-white">
              <h2 className="text-5xl font-bold mb-6">REIMAGINED</h2>
              <p className="text-xl mb-8">Join us as we reimagine the future of sport.</p>
            </div>
          </div>
        </div>
      </div> */}
        ...
        <div className="w-full max-w-md">
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  id="name"
                  className={`w-full px-4 py-3 border ${errors.name ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-black`}
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  id="phone"
                  type="tel"
                  className={`w-full px-4 py-3 border ${errors.phone ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-black`}
            ...
            <div className="mb-6">
              ...
              <select
                id="gender"
                className={`w-full px-4 py-3 border ${errors.gender ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-black`}
                {...register('gender', {
                  required: 'Gender is required'
                })}
              >
                <option className='w-auto' value="">Select your gender</option>
            ...
            <div className="mb-6 flex items-start">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                I agree to the <a href="#" className="font-medium text-black hover:underline">Terms and Conditions</a>
              </label>
            </div>
            {errors.terms && (
          ...
          <div className="mt-8 text-center">
            <p>
              ...
              <NavLink to='/login' className="font-medium text-black hover:underline">
                Log In
              </NavLink>
            </p>
          </div>
